...
mqqtClient.publish(bt + "PufferOben", mySgrp1[5], qos=1, retain=True)
mqqtClient.publish(bt + "PufferTop", mySgrp1[6], qos=1, retain=True)
...
mqqtClient.publish(bt + 'ZirkulationRL', mySgrp2[14], qos=1, retain=True)
